...
namespace KPMVCWebAPIs.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public IActionResult ListBooks()
        {
            ...
            string input = "KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString;
            Console.WriteLine("KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString) ;
        ...
        public IActionResult GetIntBook(int id)
        {
            string currentDate = DateTime.Now.ToString("MM/dd/yyyy HH:mm:sss tt");
            string input = "KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString;
            Console.WriteLine("KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString);
        ...
        public IActionResult GetInt2Book(int id)
        {
            string currentDate = DateTime.Now.ToString("MM/dd/yyyy HH:mm:sss tt");
            string input = "KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString;
            Console.WriteLine("KP : KPMVCWebAPIs : CatalogController : Today's Date : " + currentDate + "\n " + jsonString);
